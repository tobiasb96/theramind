...
class TherapyAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['created_at', 'updated_at']
    inlines = [SessionInline, DocumentInline]
    fieldsets = (
        ('Patient', {
            'fields': ('patient',)
        }),
...
class SessionAdmin(admin.ModelAdmin):
    ...
    search_fields = ['therapy__patient__first_name', 'therapy__patient__last_name', 'title', 'notes']
    readonly_fields = ['created_at', 'updated_at']
...
class DocumentAdmin(admin.ModelAdmin):
    list_display = ['therapy', 'title', 'document_type', 'created_at']
    list_filter = ['document_type', 'created_at']
    search_fields = ['therapy__patient__first_name', 'therapy__patient__last_name', 'title', 'content']
    readonly_fields = ['created_at', 'updated_at']
