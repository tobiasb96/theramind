...
from sessions.models import Session, AudioRecording, Transcription
...
class AudioViewSet(viewsets.ViewSet):
    ...
    def get_session(self, patient_pk, therapy_pk, session_pk):
    ...
    def upload(self, request, patient_pk=None, therapy_pk=None, session_pk=None):
        """Upload audio file to a session"""
        session = self.get_session(patient_pk, therapy_pk, session_pk)
    ...
    def transcribe(self, request, pk=None):
        ...
        if not transcription_service.is_available():
            ...
            return redirect('therapy:session_detail', 
                          patient_pk=session.therapy.patient.pk,
                          therapy_pk=session.therapy.pk,
