...
urlpatterns = [
    ...
    path("<int:pk>/upload-context-file/", report_viewset.upload_context_file, name="upload_context_file"),
    path("<int:pk>/add-context-text/", report_viewset.add_context_text, name="add_context_text"),
    path("<int:pk>/delete-context-file/", report_viewset.delete_context_file, name="delete_context_file"),
